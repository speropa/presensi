    ...
    // 2. Logika Caching Anda untuk fungsionalitas offline.
    const CACHE_NAME = 'presensi-guru-cache-v4'; // Versi cache dinaikkan untuk memastikan pembaruan
    const urlsToCache = [
        './',
        './index.html',
        './manifest.json',
        // 'https://cdn.tailwindcss.com', // DIHAPUS untuk memperbaiki error CORS
